...
const Pricing = () => {
	...
	const plans = [
		{
			...
			features: [
				"Basic AI recipe generation (5 per month)",
	...
	const faqs = [
		...
		},
		{
			...
			answer:
				"Yes! We offer a 7-day free trial for both Premium and Family plans. No credit card required to start.",
		},
		{
			question: "What happens to my recipes if I downgrade?",
			answer:
				"Your recipes are always yours. If you downgrade, you'll keep all your imported recipes but may lose access to premium features.",
		},
		{
			question: "Can I switch between monthly and yearly billing?",
			answer:
				"Absolutely! You can change your billing frequency in your account settings at any time.",
		},
		{
			question: "Do you offer student discounts?",
			answer:
				"Yes, we offer a 50% discount for students with valid student ID. Contact our support team to apply.",
		},
		{
			question: "What payment methods do you accept?",
			answer:
				"We accept all major credit cards, PayPal, and Google Pay through secure payment processing.",
		},
	];
			...
			<section className="bg-gradient-to-br from-orange-50 via-white to-green-50 py-20">
				<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					...
					<p className="text-xl text-gray-600 leading-relaxed mb-8">
						Choose the plan that fits your cooking style. Start free, upgrade
						when you're ready.
					</p>
