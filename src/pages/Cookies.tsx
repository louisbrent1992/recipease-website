...
const Cookies = () => {
	...
	const cookieTypes = [
		...
		},
		{
			...
			description:
				"Remember your preferences and provide customized experience",
				...
				<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-12">
						...
						<p className="text-lg text-gray-600">
							Control which cookies you want to allow. Essential cookies cannot
							be disabled.
						</p>
					</div>
					...
					<div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
						<div>
							...
							<div className="space-y-4 text-gray-600">
								<p>
									RecipEase uses cookies to enhance your browsing experience and
									provide personalized services. Here's how we use different
									types of cookies:
								</p>
								<ul className="list-disc pl-4 space-y-2">
									...
									<li>
										<strong>Analytics:</strong> Understand how you use our
										website to improve it
									</li>
									<li>
									...
									<li>
										<strong>Performance:</strong> Optimize loading times and
										functionality
									</li>
								</ul>
							</div>
						...
						<div>
							...
							<div className="space-y-4 text-gray-600">
								<p>
									We may also use third-party services that set their own
									cookies:
								</p>
								<ul className="list-disc pl-4 space-y-2">
									<li>
									...
									<li>
										<strong>Social Media:</strong> Social sharing and login
										functionality
									</li>
									<li>
									...
									<li>
										<strong>Customer Support:</strong> Live chat and support
										services
									</li>
								</ul>
								<p>
						...
						<div>
							...
							<div className="space-y-4 text-gray-600">
								...
								<ul className="list-disc pl-4 space-y-2">
									...
									<li>
										<strong>Our Cookie Settings:</strong> Use the controls above
										to manage our cookies
									</li>
									<li>
									...
									<li>
										<strong>Mobile Settings:</strong> Adjust tracking settings
										on mobile devices
									</li>
								</ul>
								<p>
						...
						<div>
							...
							<div className="space-y-4 text-gray-600">
								...
								<ul className="list-disc pl-4 space-y-2">
									...
									<li>
										<strong>Authentication Cookies:</strong> Expire when you log
										out or after inactivity
									</li>
									<li>
										<strong>Preference Cookies:</strong> Remain until you change
										your settings
									</li>
								</ul>
							</div>
						...
						<div className="border-t pt-8">
							<p className="text-sm text-gray-500 text-center">
								This Cookie Policy is effective as of March 1, 2025, and applies
								to all visitors and users of the RecipEase website and services.
							</p>
						</div>
					</div>
				</div>
