			...
			<section className="bg-gradient-to-br from-orange-50 via-white to-green-50 py-20">
				<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					...
					<p className="text-xl text-gray-600 leading-relaxed">
						Get personalized recipe recommendations, cooking tips, and culinary
						...
						<div className="space-y-8">
							<div className="space-y-4">
								...
								<p className="text-xl text-orange-100 max-w-2xl mx-auto">
									Subscribe to our weekly digest and never run out of delicious
									recipe ideas. It's free, personalized, and delivered every
									Thursday.
								</p>
							</div>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center space-y-4 mb-16">
						...
						<p className="text-xl text-gray-600">
							Our AI curates the perfect mix of recipes and content just for you
						</p>
					</div>
							...
							<div className="space-y-6">
								...
								<div className="border-t pt-6">
									...
									<p className="text-gray-600">
										Add a splash of acid (lemon juice, vinegar, or wine) to your
										dishes just before serving to brighten flavors and make them
										pop!
									</p>
								</div>
								...
								<div className="border-t pt-6">
									...
									<p className="text-gray-600">
										Spring asparagus is at its peak! Try grilling it with olive
										oil and lemon zest for a simple, elegant side dish that
								...
								<div key={key} className="flex items-center justify-between">
									<div>
										...
										<p className="text-gray-600 text-sm">
											{key === "weeklyDigest" &&
												"Get personalized recipe recommendations every Thursday"}
											{key === "newFeatures" &&
												"Be the first to know about new RecipEase features"}
											{key === "cookingTips" &&
												"Improve your culinary skills with expert tips"}
											{key === "specialOffers" &&
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
						<div className="bg-gray-50 rounded-xl p-6">
							<div className="space-y-4">
								...
								<p className="text-gray-700 italic">
									"The weekly digest has completely transformed my meal
									planning. I look forward to it every Thursday!"
								</p>
								<div>
						...
						<div className="bg-gray-50 rounded-xl p-6">
							<div className="space-y-4">
								...
								<p className="text-gray-700 italic">
									"The seasonal ingredient spotlights have introduced me to so
									many new flavors. Love the cooking tips too!"
								</p>
								<div>
									<p className="font-semibold text-gray-900">Mike R.</p>
									<p className="text-gray-600 text-sm">
										Food Enthusiast, Austin
									</p>
								</div>
							</div>
						</div>
