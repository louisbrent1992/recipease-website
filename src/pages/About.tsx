...
const About = () => {
	const values = [
		...
		},
		{
			...
			description:
				"Our users are at the heart of everything we do. We build features based on real needs and feedback.",
		},
		{
			icon: <Target className="h-12 w-12 text-green-500" />,
			title: "Innovation",
			description:
				"We harness cutting-edge AI technology to solve real problems and enhance the cooking experience.",
		},
		{
			icon: <Globe className="h-12 w-12 text-purple-500" />,
			title: "Accessibility",
			description:
				"Great food and cooking knowledge should be available to everyone, everywhere.",
		},
	];
	...
	const timeline = [
		{
			...
			title: "The Idea",
			description:
				"Founded with a vision to make cooking more accessible and enjoyable using AI technology.",
		},
		{
			year: "2024",
			title: "Beta Launch",
			description:
				"Launched beta version with core AI recipe generation and import features.",
		},
		{
			year: "2024",
			title: "Community Growth",
			description:
				"Reached 10,000 users and introduced weekly digest feature based on user feedback.",
		},
		{
			year: "2025",
			title: "Global Expansion",
			description:
				"Expanded to 50+ countries with localized content and multi-language support.",
		},
	];
				...
				<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
							...
							<div className="text-center space-y-6">
								...
								<div>
									<h3 className="text-2xl font-bold text-gray-900">
										Advent Hub Solutions
									</h3>
									<p className="text-gray-600">The company behind RecipEase</p>
								</div>
								<div className="bg-white rounded-lg p-4 text-left">
									<p className="text-gray-700 text-sm">
										A technology company focused on creating innovative
										solutions that make everyday tasks more efficient and
										enjoyable through artificial intelligence.
									</p>
								</div>
							</div>
						</div>
						<div className="space-y-6">
							...
							<p className="text-lg text-gray-600 leading-relaxed">
								RecipEase is proudly developed by Advent Hub Solutions, a
								forward-thinking technology company specializing in AI-powered
								consumer applications. Our team combines deep technical
				...
				<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					<div className="space-y-8">
						...
						<p className="text-xl text-orange-100">
							Be part of a community that's transforming the way the world
