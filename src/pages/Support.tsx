	...
	const commonQuestions = [
		{
			...
			answer:
				'Open the RecipEase app, tap the "Import" button, and paste the Instagram post URL. Our AI will automatically extract and format the recipe for you.',
		},
		{
			question: "Can I use RecipEase offline?",
			answer:
				"Yes! All your saved recipes are available offline. However, you'll need an internet connection for AI recipe generation and importing new recipes.",
		},
		{
			question: "How does the AI recipe generator work?",
			answer:
				"Our AI analyzes your preferences, dietary restrictions, and available ingredients to create personalized recipes. The more you use it, the better it gets at understanding your taste.",
		},
		{
			question: "Can I share my recipes with family?",
			answer:
				"Absolutely! You can share individual recipes or create shared collections with family members. Premium users can also create collaborative shopping lists.",
		},
		{
			question: "How do I cancel my subscription?",
			answer:
				"You can cancel your subscription anytime in the app settings or by contacting our support team. Your access will continue until the end of your billing period.",
		},
		{
			question: "Is my recipe data secure?",
			answer:
				"Yes, we take data security seriously. All your recipes are encrypted and backed up securely. We never share your personal recipe data with third parties.",
		},
	];
			...
			<section className="bg-gradient-to-br from-orange-50 via-white to-green-50 py-20">
				<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					...
					<p className="text-xl text-gray-600 leading-relaxed">
						Get the support you need to make the most of RecipEase. Our team is
				...
				<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					<div className="space-y-8">
						...
						<p className="text-xl text-orange-100">
							Explore our comprehensive help resources or connect with our
							community
						</p>
