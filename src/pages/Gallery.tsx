			...
			<section className="bg-gradient-to-br from-orange-50 via-white to-green-50 py-20">
				<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					...
					<p className="text-xl text-gray-600 leading-relaxed">
						Explore RecipEase through screenshots, feature graphics, and brand
						assets. See how our beautiful design meets powerful functionality.
					</p>
				</div>
			</section>
						...
						<div className="aspect-video bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center">
							<div className="text-center space-y-4">
								...
								<p className="text-gray-300">
									Full app walkthrough video will be available here
								</p>
					...
					<div className="bg-orange-500 rounded-2xl p-12 text-center text-white">
						<div className="space-y-6">
							...
							<p className="text-xl text-orange-100">
								Get high-resolution logos, screenshots, and brand assets for
